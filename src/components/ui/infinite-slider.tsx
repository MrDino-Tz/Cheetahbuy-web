...
export function InfiniteSlider({
  ...
  // Convert speed (pixels per second) to duration (seconds for one full loop)
  ...
  const hoverProps = effectiveDurationOnHover || speedOnHover
    ? {
        onHoverStart: () => {
          setIsTransitioning(true);
          setCurrentDuration(effectiveDurationOnHover || 100 / speedOnHover!);
        },
        onHoverEnd: () => {
          setIsTransitioning(true);
          setCurrentDuration(effectiveDuration);
